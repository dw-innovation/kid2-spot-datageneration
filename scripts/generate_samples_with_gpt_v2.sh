...
python -m datageneration.gpt_data_generator_v2 \
...
--output_prompt_generations datageneration/results/${VERSION}/prompt_generations_with_prompt_v2.jsonl \
--output_gpt_generations datageneration/results/${VERSION}/gpt_generations_with_prompt_v2.jsonl \
--system_prompt datageneration/prompts/system_prompt.txt \
